// Bibliotheque
const { input, select } = require('@inquirer/prompts'); // npm i inquirer
const isFloat = require('is-float'); // npm i is-float
const isNumber = require('is-number'); // npm i is-number
